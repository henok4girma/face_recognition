...
image = "/home/pi/Raspberrypi_workshop/Face_Detection_System/henok.jpg"
image2 = "/home/pi/Raspberrypi_workshop/Face_Detection_System/mengistu.jpg"
...
henok_image = face_recognition.load_image_file(image)
henok_face_encoding = face_recognition.face_encodings(henok_image)[0]

# Load a second sample picture and learn how to recognize it.
mengistu_image = face_recognition.load_image_file(image2)
mengistu_face_encoding = face_recognition.face_encodings(mengistu_image)[0]

# Create arrays of known face encodings and their names
known_face_encodings = [
    henok_face_encoding,
    mengistu_face_encoding
]
known_face_names = [
    "henok_girma",
    "mengistu_ashebir"
                    ...
                    if(name == "Unknown"):
                        ...
                        if(inside_home == 0):
                            ...
                            while i < 10:
                                ...
                                i += 1
                                Sender_Email = "girmahenok57@gmail.com"
                                Reciever_Email = "henaaait4@gmail.com"
                                Password = "oicd ublz oryd mhpt" #type your password here
